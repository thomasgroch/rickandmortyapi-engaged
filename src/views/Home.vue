<template>
  <PageWrapper title="Início">
    <div class="pl-5 pt-3 flex justify-center items-center">
      <span class="px-3">Pesquisar por nome:</span>
      <input type="text" v-model="searchQuery" placeholder="Rick" class="p-2 rounded-md w-64" @input="currentPage = 1">
    </div>
